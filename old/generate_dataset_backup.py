...
def main():
    ...
    # 3 add all info
    watched = addIMDbData(watched, title_basics, title_rate, title_prin_mega_path)
...
def addIMDbData(watched, title_basics, title_rate, title_prin_mega_path):
...
def addCastAndCrew(watched_title_rate, title_prin_mega_path):
